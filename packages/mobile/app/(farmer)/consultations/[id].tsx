    ...
    return (
      <View style={[styles.msgRow, isMine ? styles.msgRowMe : styles.msgRowOther]}>
        ...
        <View style={styles.bubbleWrap}>
          ...
          <Text style={[styles.time, isMine ? styles.timeMe : styles.timeOther]}>
            {time}
          </Text>
        </View>
      </View>
            ...
            ListEmptyComponent={
              <View style={styles.emptyChat}>
                ...
                <Text style={styles.emptyChatText}>
                  ...
                  Décrivez vos préoccupations au vétérinaire.
                </Text>
              </View>
            }
          />
...
const styles = StyleSheet.create({
  ...
  moreBtn: { padding: 8 },
  wave: { height: 16, backgroundColor: '#F0F4F3', borderTopLeftRadius: 16, borderTopRightRadius: 16 },
